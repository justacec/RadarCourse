...
{
\question[2]{a}{Calculate its gain}
{
...
\question[2]{b}{Calculate its peak RCS in the midband of L, W, C, X, and Ku. What is the equation relating its gain to RCS, as a function of $\lambda$? (See Tables 3.1 and 3.2.)}{}
}
...
& = \left[\frac{(40)(2\cdot 30)(-13.01)(-20)(-15.2)}{1}\right]^{\frac{1}{4}}
\end{align*}

*Note: Do not forget to convert the resulting R which will be in dB back to a physical distance and to take into account that the $\frac{1}{4}$ power really turns into a divide by 4 in the dB space...
...
\question[2]{a.}{What is its maximum unambiguous range $R_u$?}{}
\question[2]{b.}{Suppose its frequency is changed to mid-Ku band and other parameters remain the same. Calculate $\Delta \nu_\mu$ and $R_u$.}{}

}

\question{1.5}{Calculate range gate width $\Delta R$ in both meters and feet for $\tau=0.01, 0.1, 1, \text{and} 10 \mu$sec. What is the appropriate relationship between $\tau$ (nsec) and $\Delta R$ (feet)?}
{}
